...
class Game:
    ...
    def __init__(self, master):
        self.WORDS = {'Colors':'red;orange;yellow;green;blue;indigo;violet;white;black;brown'.split(';'),
                      ...
                      'Comic Book Movies':'Iron Man;The Incredible Hulk;Iron Man II;Thor;Thor: The Dark World;Captain America: The First Avenger;Marvel\'s The Avengers;Captain America: The Winter Soldier;Ant-Man;Guardians of the Galaxy;Iron Man 3'.split(';')
